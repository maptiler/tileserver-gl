...
* Fix loading local data sources (PMTiles/MBTiles) specified in style and improve handling of sparse tiles (https://github.com/maptiler/tileserver-gl/pull/1855) by @acalcutt
